...
steps_for(:ra_resource) do
  ...
  #   "Given a organization with login: 'mojojojo'" 
  # produces a Organization instance stored in @organization with 'mojojojo' as its login
  # attribute.
  #
  ...
  #   "And the organization has thac0: 3"
  # takes the earlier-defined @organization instance and sets its thac0 to '3'.
  #
...
#
# So, for instance,
#   klass, instance = parse_resource_args 'organization'
#   instance = klass.new({login => 'me', password => 'monkey', ...})
#   keep_instance! resource, instance
# keeps the just-constructed Organization model in the @organization instance variable.
#
