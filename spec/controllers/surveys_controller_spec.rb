require File.dirname(__FILE__) + '/../spec_helper'
  ...
  describe SurveyController, " handling POST /surveys" do
    it "should create a new survey by sponsor_id"
    it "should redirect to the new survey"
  end
  ...
  describe SurveysController, " handling DELETE /surveys/1" do
    ...
    it "should delete related questions"
    it "should delete related discussions"
    it "should delete related invitations"
